  ...
  render() {
    ...
    return (
      <View style={{ marginTop: 20 }}>
        ...
        <Button title='Trocar Nome' onPress={() => this.alterarNome('Otávio')} />
        <Text style={{ marginTop: 20, color: 'blue', textAlign: 'center' }}>
          {this.state.nome}
        </Text>

        {/* Mais de um estilo, coloca entre colchetes */}
        <Text style={[estilos.area, estilos.centraliza]}>
          Eu sou o Texto 1
        </Text>
...
class Rocket extends Component {
  render() {
    ...
    let img = 'https://blog.rocketseat.com.br/content/images/2019/03/React-Hooks-Comoutilizar--motivac-o-es-eexemplos-pra-ticos.png';
